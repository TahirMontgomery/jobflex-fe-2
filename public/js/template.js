...
//Primary use:	Joblly - Responsive Admin Template
...
+(function ($) {
  ...
  (function ($) {
    ...
    BoxWidget.prototype.expand = function () {
      ...
      $(this.element)
        .find(Selector.body + ", " + Selector.footer)
        .slideDown(
          this.options.animationSpeed,
          function () {
            $(this.element).trigger(expandedEvent);
  ...
  (function ($) {
    ...
    $(document).on("click", ".box-btn-maximize", function () {
      $(this)
        .parents(".box")
        .toggleClass("box-maximize")
        .removeClass("box-fullscreen");
    });
    ...
    $(".custom-file-control:not([data-input-value])").attr(
      "data-input-value",
      "Choose file..."
    );
